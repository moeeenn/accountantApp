...
//                adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            ...
            public void onFailure(Call<List<get_category>> call, Throwable t) {
                ...
                Toast.makeText(edit_product_activity.this, "خطا در برقراری ارتباط", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                iRetrofit.edit_delete_product(pna.getText().toString(),0,p_Id,Integer.parseInt(ppr.getText().toString())
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        try {
                            ...
                            if (message.equals("1"))
                            {
                                Toast.makeText(edit_product_activity.this, "موفقیت آمیز بود", Toast.LENGTH_SHORT).show();
                                edit_product_activity.this.finish();
                            }
                            else
                                Toast.makeText(edit_product_activity.this, "موفقیت آمیز نبود", Toast.LENGTH_SHORT).show();
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                    }
